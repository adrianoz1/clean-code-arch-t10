...
test("Deve fazer uma corrida em um domingo e horário normal", function () {
  const segments = [
...
test("Deve fazer uma corrida em um domingo e horário noturno", function () {
  const segments = [
...
test("Deve retornar uma corrida com valor mínimo", function () {
  const segments = [
