...
import OvernightFareSundayCalculator from "./OvernightFareSundayCalculator";
...
export default class FareCalculatorFactory {
  static create(segment: Segment) {
    ...
    if (segment.isOvernight() && segment.isSunday()) return new OvernightFareSundayCalculator();
